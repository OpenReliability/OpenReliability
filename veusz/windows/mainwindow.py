...
class MainWindow(qt4.QMainWindow):
    ...
    def askTutorial(self):
        ...
        retn = qt4.QMessageBox.question(
            self, _("OpenReliability Tutorial"),
            _("OpenReliability includes a tutorial to help get you started.\n"
    ...
    def updateTitlebar(self):
        ...
        if self.filename == '':
            self.setWindowTitle(_('Untitled - OpenReliability'))
        else:
            self.setWindowTitle( _("%s - OpenReliability") %
